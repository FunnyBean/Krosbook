...
var ReservationService = (function () {
    ...
    ReservationService.prototype.getReservations = function (type, id, from, to) {
        ...
        return this.http.post('http://funnybean.cloudapp.net/api/reservations/' + type + '/' + by + '/' + id, JSON.stringify({ from: from, to: to }), { headers: headers });
    };
    ReservationService.prototype.addReservation = function (type, elementId, userId, name, date, length) {
        ...
        if (type == "rooms") {
            ...
            return this.http.post('http://funnybean.cloudapp.net/api/reservations/' + type + '/', JSON.stringify({ roomId: roomId, name: name, date: date, length: length }), { headers: headers });
        }
        else {
            var carId = elementId;
            return this.http.post('http://funnybean.cloudapp.net/api/reservations/' + type + '/', JSON.stringify({ carId: carId, name: name, date: date, length: length }), { headers: headers });
        }
    };
    ReservationService.prototype.editReservation = function (type, id, name, elementId, userId, dateTime, length, roomReservationRepeaterId, emailInvitation, goToMeeting) {
        ...
        if (type == "rooms") {
            var roomId = elementId;
            return this.http.put('http://funnybean.cloudapp.net/api/reservations/' + type + '/' + id, JSON.stringify({ id: id, name: name, roomId: roomId, dateTime: dateTime, userId: userId, length: length, roomReservationRepeaterId: roomReservationRepeaterId, emailInvitation: emailInvitation, goToMeeting: goToMeeting }), { headers: headers });
        }
        else {
            var carId = elementId;
            return this.http.put('http://funnybean.cloudapp.net/api/reservations/' + type + '/' + id, JSON.stringify({ id: id, name: name, carId: carId, dateTime: dateTime, userId: userId, length: length }), { headers: headers });
        }
    };
    ...
    ReservationService.prototype.addRepeatingReservation = function (type, reservationId, repetation, interval, endType, appearance, endingDate) {
        ...
        return this.http.post('http://funnybean.cloudapp.net/api/reservations/' + type + '/repetition', JSON.stringify({ reservationId: reservationId, repetation: repetation, interval: interval, appearance: appearance, endingDate: endingDate }), { headers: headers });
    };
    ReservationService.prototype.editRepeatingReservation = function (type, id, reservationId, repetation, interval, endType, appearance, endingDate) {
        ...
        appearance = (endType == 'appearance') ? appearance : null;
        endingDate = (endType == 'date') ? moment(endingDate).format("DD.MM.YYYY HH:mm:ss") : null;
        return this.http.put('http://funnybean.cloudapp.net/api/reservations/' + type + '/repetition/' + id, JSON.stringify({ id: id, reservationId: reservationId, repetation: repetation, interval: interval, appearance: appearance, endingDate: endingDate }), { headers: headers });
    };
