...
export class ReservationService {
  ...
  public editRepeatingReservation(type:string, id:number, reservationId:number, startDate:any, repetation:string, interval:number, endType:string, appearance:number, endingDate:any){
    let headers = new Headers();
    headers.append('Content-Type', 'application/json');
    appearance = (endType == 'appearance') ? appearance : null;
    endingDate = (endType == 'date') ? moment(endingDate).format("DD.MM.YYYY HH:mm:ss") : null;
